...
INSERT INTO `relations` VALUES (1,NULL,'SPORTLED NEDERLAND B.V.',28869,NULL,'AMSTERDAM'),(2,NULL,'OASEN DRINKWATER N.V.',24157,NULL,'GOUDA'),(3,NULL,'SONNEBORN REFINED PRODUCTS BV',12182,NULL,'AMSTERDAM'),(4,NULL,'SONNEBORN REFINED PRODUCTS BV',12182,NULL,'AMSTERDAM'),(5,NULL,'VOLKER WESSELS TELECOM',31372,NULL,'AMERSFOORT'),(6,NULL,'VOLKER WESSELS TELECOM',31372,NULL,'AMERSFOORT'),(7,NULL,'VOLKER WESSELS TELECOM',31372,NULL,'AMERSFOORT'),(8,NULL,'PETROCHEMICAL PIPELINE SERVICES BV',1088,NULL,'ELSLOO'),(9,NULL,'PETROCHEMICAL PIPELINE SERVICES BV',1088,NULL,'ELSLOO'),(10,NULL,'LARS YACHT CHARTER B.V.',21362,NULL,'WIERDEN'),(11,NULL,'CONVER B.V.',11612,NULL,'GIESSEN'),(12,NULL,'ATLAS COPCO NEDERLAND B.V.',10177,NULL,'ZWIJNDRECHT'),(13,NULL,'WL TECHNISCH ONDERHOUD B.V.',32294,NULL,'ROTTERDAM'),(14,NULL,'SCHOLTUS SPECIAL PRODUCTS',1364,NULL,'RENSWOUDE'),(15,NULL,'ALEWIJNSE DELFT B.V.',10427,NULL,'DELFT'),(16,NULL,'STRABAG B.V.',28846,NULL,'VLAARDINGEN');
